...
public class ClientHandler extends Thread {
    ...
    private void payMoney(Object obj) throws IOException, ClassNotFoundException {
        ...
        boolean res = bnk.getMoney(op.getSerNum(), op.getAmount());
        if (res) {
    ...
    private void getCardInfo(Object operation) throws IOException, ClassNotFoundException {
        CardInfoOperation cardInfoOperation = (CardInfoOperation) operation;
        String info = bnk.displayCardInfo(cardInfoOperation.getSerialNumber());
