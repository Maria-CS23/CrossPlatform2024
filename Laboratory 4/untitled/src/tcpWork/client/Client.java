...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        op.getCrd().setUser(new User("Petr", "Petrov", "M", "25.12.1968"));
        op.getCrd().setSerNum("00001");
        op.getCrd().setCollege("KhNU");
        op.getCrd().setBalance(25);
        cl.applyOperation(op);
        cl.applyOperation(new CardInfoOperation("00001"));
        cl.finish();
        ...
        cl.applyOperation(new RemoveCardOperation("00001"));
        cl.applyOperation(new CardInfoOperation("00001"));
