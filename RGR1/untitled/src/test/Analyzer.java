...
public class Analyzer {
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                    ...
                    step = scanDouble();
                    System.out.println("Введіть значення параметра 'a': ");
                    double aValue = scanDouble();
                    withParam(func, from, to, step, aValue);
                    break;
                case 2:
                    System.out.println("Введіть функцію: ");
                    func = scanLine();
    ...
    public static void withParam(String funStr, double from, double to, double step, double aValue) {
